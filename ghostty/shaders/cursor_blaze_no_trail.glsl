...
const vec4 TRAIL_COLOR = vec4(0, 0.5, 0, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0, 0.5, 0, 1.0);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    //cursorblaze
    vec4 trail = mix(TRAIL_COLOR_ACCENT, fragColor, 1. - smoothstep(0., sdfCurrentCursor + .001, 0.001));
    trail = mix(TRAIL_COLOR, trail, 1. - smoothstep(0., sdfCurrentCursor + .001, 0.001));
